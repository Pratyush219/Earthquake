...
public class QueryUtils {
     ...
     */
    public static ArrayList<Earthquake> extractEarthquakes(Context context, RecyclerView view, ProgressBar bar) {
...
//                            Toast.makeText(context, "Entered try-catch block!", Toast.LENGTH_SHORT).show();
                            ...
                            Log.i("Length of JSONArray", ""+length);
                ...
                error -> Toast.makeText(context,"Err...Nikal bhai",Toast.LENGTH_SHORT).show());
        requestQueue.add(stringRequest);
//        if(root == null){
//            bar.setVisibility(View.GONE);
//            Toast.makeText(context, "Error when data fetched", Toast.LENGTH_SHORT).show();
//            return null;
//        }

        // Return the list of earthquakes
//        while(earthquakes.size()<length);
        return earthquakes;
    }


//    private class QuakeRunnable implements Runnable{
//        int index;
//
//        public QuakeRunnable(int index) {
//            this.index = index;
//        }
//
//        @Override
...
//                Log.i("Emergency: ","Exception occurred while attempting to create URL");
//                return null;
//            }
//            return url;
//        }
...
//            try {
//                JSONArray features = new JSONObject(jsonResponse).getJSONArray("features");
//                if(features.length()>0){
//                    JSONObject details = features.getJSONObject(index).getJSONObject("properties");
//
//                }
//
//
